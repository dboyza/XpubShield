...
pub fn score_recovery_readiness(report: &WalletReport) -> RecoveryHealthReport {
    ...
    if !report
        .descriptors
        .iter()
        .any(|descriptor| descriptor.keychain == crate::models::Keychain::Change)
    {
    ...
    if report
        .descriptors
        .iter()
        .any(|descriptor| descriptor.master_fingerprint.is_none())
    {
    ...
    if report
        .descriptors
        .iter()
        .any(|descriptor| descriptor.checksum.is_none())
    {
